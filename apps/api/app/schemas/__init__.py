...
from app.schemas.progress import ProgressResponse, AttemptRequest, CompleteRequest, SubmitCompletionResponse, UserProgressSummary
...
__all__ = [
    ...
    "ProgressResponse", "AttemptRequest", "CompleteRequest", "SubmitCompletionResponse", "UserProgressSummary",
